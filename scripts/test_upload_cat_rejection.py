...
body.append(f'Content-Disposition: form-data; name="file"; filename="cat.jpg"'.encode())
...
print("Attempting to upload cat image via POST /api/complaints/upload-image...")
try:
